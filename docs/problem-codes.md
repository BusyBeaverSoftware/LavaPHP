...
| `invalid_listeners_file` | `InvalidListenersFile` (events) | `app/Listeners.php` does not return a map from event class names to a listener id or a non-empty list of ids | quote the file and the shape to write |
