<!-- lava:map hash=3321c4ff985b1213 -->
# AGENTS.md
...
|-------|-------|------|-----------|
| lava/db | db | DbModule | app/Modules.php:27 |
| lava/validate | validate | ValidateModule | app/Modules.php:28 |
| lava/view | views | ViewModule | app/Modules.php:29 |
| lava/http-client | http_client | HttpClientModule | app/Modules.php:30 |
...
| http_client | on | lava/http-client | gate for pack lava/http-client |
