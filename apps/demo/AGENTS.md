<!-- lava:map hash=e24094035a3a9182 -->
# AGENTS.md
...
| Lava\Events\ListenerMap | singleton | Lava\Events\ListenerMap | events:src/EventsModule.php:56 |
| Lava\Events\ListenerProvider | singleton | Lava\Events\ListenerProvider | events:src/EventsModule.php:58 |
| Lava\Events\EventDispatcher | singleton | Lava\Events\EventDispatcher | events:src/EventsModule.php:76 |
...
Each event class or interface in app/Listeners.php and the listeners it reaches, in the order they run. An event reaches the listeners of every entry it is an instance of; dispatch with Lava\Events\EventDispatcher. Listed by lavaphp/events.
