<!-- lava:map hash=db93f91e51aa0851 -->
# AGENTS.md
...
|-------|-------|------|-----------|
| lava/db | db | DbModule | app/Modules.php:20 |
| lava/validate | validate | ValidateModule | app/Modules.php:21 |
| lava/view | views | ViewModule | app/Modules.php:22 |
...
|----|-------|----|-----------|
| db | on | lava/db | gate for pack lava/db |
| validate | on | lava/validate | gate for pack lava/validate |
| views | on | lava/view | gate for pack lava/view |
...
|----|-----------|------|-----------|-------|
| DATABASE_DSN | optional | - | lava/db | Read by lava/db. |
| DATABASE_USER | optional | - | lava/db | Read by lava/db. |
| DATABASE_PASSWORD | optional | - | lava/db | Read by lava/db. |
